...
func TestResolveFormat_DefaultsReproduceLegacyMapping(t *testing.T) {
	...
	cases := []struct {
		...
		{"3d conversion", tags("3D Conversion", "SBS"), Format{Projection: "perspective", Stereo: "sbs"}},
		{"alpha passthrough", tags("FISHEYE", "Alpha"), Format{Projection: "fisheye", Stereo: "sbs", Passthrough: true}},
		{"passthrough label alone", tags("FISHEYE", "Passthrough"), Format{Projection: "fisheye", Stereo: "sbs"}},
		{"augmented reality label alone", tags("Augmented Reality"), Format{}},
		...
		{"180 degrees label alone", tags("180°"), Format{}},
		{"360 degrees label alone", tags("360°", "TB"), Format{Stereo: "tb"}},
		{"sphere", tags("SPHERE"), Format{Projection: "equirectangular360", Stereo: "sbs"}},
		{"sphere tb", tags("360°", "SPHERE", "TB"), Format{Projection: "equirectangular360", Stereo: "tb"}},
		{"dome with 180 label", tags("180°", "DOME"), Format{Projection: "equirectangular", Stereo: "sbs"}},
